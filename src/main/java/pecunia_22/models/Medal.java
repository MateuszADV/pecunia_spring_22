...
@Entity
@Table(name = "medals")
public class Medal extends Common{

    public Medal(String itemDate, Date dateBuy, String nameCurrency, Double priceBuy, Double priceSell,
    ...
    @SequenceGenerator(
            name = "medals_sequence",
            sequenceName = "medals_sequence",
            allocationSize = 1
    )
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "medals_sequence"
    )
    private Long id;
