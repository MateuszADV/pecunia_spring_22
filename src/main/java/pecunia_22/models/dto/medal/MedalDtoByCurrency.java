package pecunia_22.models.dto.medal;
...
@Setter
@ToString
public class MedalDtoByCurrency extends CommonDto {

    public MedalDtoByCurrency(String itemDate, Date dateBuy, String nameCurrency, Double priceBuy, Double priceSell,
